/*=========================================================================
  ...
  Program:   LidarView
  Module:    vtkTemporalTransforms.h
...
public:
  ...
  //  static vtkSmartPointer<vtkTemporalTransforms> CreateFromInterpolator(const
  ...
  vtkDataArray* GetOrientationArray()
  {
    return this->GetPointData()->GetArray(OrientationArrayName);
  }
